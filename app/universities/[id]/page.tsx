...
import { UniversityDetails } from "@/types"; // Fayl yo'lingizga qarab moslab oling
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 py-10">
            ...
            <div className="flex items-end justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="mt-3 text-sm tracking-wide text-white/50">
                  {university.foundedYear}-yilda tashkil etilgan ·{" "}
                  {university.type} Universiteti · {university.region}
                </p>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          ...
          <div className="rounded-2xl p-5 bg-white/5 border border-white/10">
            ...
            <div className="text-xs mt-1 text-white/35">
              Times Higher Education — ilmiy tadqiqotlar bo'yicha o'rni
            </div>
          </div>
          <div className="rounded-2xl p-5 bg-white/5 border border-white/10">
            <div className="text-xl mb-2">🎯</div>
            ...
            <div className="text-xs mt-1 text-white/35">
              100 ariza bersangiz atigi o'rtacha shuncha kishi qabul qilinadi
            </div>
          </div>
          <div className="rounded-2xl p-5 bg-white/5 border border-white/10">
            <div className="text-xl mb-2">💼</div>
            ...
            <div className="text-xs mt-1 text-white/35">
              Bitiruvchilarning ma'lum foizi 6 oy ichida ish topadi
            </div>
          </div>
        </div>
            ...
            <div className="rounded-2xl bg-white/[0.03] border border-white/[0.07] p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-indigo-200">
                    {university.totalStudents} nafar
                  </div>
                </div>
                <div>
                  <div className="text-xs text-white/35 mb-1">
                  ...
                  <div className="text-sm font-medium text-white/75">
                    {university.totalTeachers}+ professor
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-white/[0.03] border border-white/[0.07] p-6">
              ...
              <div className="relative pl-7 border-l border-indigo-500/30 flex flex-col gap-5">
                ...
                <div className="relative">
                  ...
                  <div className="text-sm font-medium text-white/80 mt-0.5">
                    {university.deadline2}
                  </div>
                </div>
                <div className="relative">
                  <div className="absolute w-3 h-3 rounded-full bg-indigo-500 border-2 border-[#060c1a] left-[-1.6rem] top-[0.15rem]" />
                  <div className="text-xs font-semibold text-indigo-400 tracking-wide">
                    Natijalar chiqish sanasi
                  </div>
                  <div className="text-sm font-medium text-white/80 mt-0.5">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="rounded-2xl p-6 relative overflow-hidden bg-gradient-to-br from-indigo-950/80 to-purple-950/60 border border-indigo-500/30">
              ...
              <div className="text-xs flex flex-col gap-2 border-t border-white/10 pt-3">
                <div className="flex justify-between">
                  <span>Ehtiyojga asoslangan grant:</span>{" "}
                  <span className="text-green-400 font-bold">
                    {university.needBasedGrant}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Yutuqlarga asoslangan grant:</span>{" "}
                  <span className="text-green-400 font-bold">
                    {university.meritBasedGrant}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-white/[0.03] border border-white/[0.07] p-6">
              ...
              <div className="flex flex-col gap-4">
                <div>
                  <div className="text-xs text-white/35 mb-1">
                    Joylashuv turi (Location)
                  </div>
                  <div className="text-sm font-medium text-indigo-200">
                    {university.locationType}
                  </div>
                </div>
                <div>
                  <div className="text-xs text-white/35 mb-1">
                    Yotoqxona imkoniyati
                  </div>
                  <div className="text-sm font-medium text-white/75">
                ...
                <div>
                  <div className="text-xs text-white/35 mb-1">
                    O'rtacha oylik maosh (Bitiruvchilar)
                  </div>
                  <div className="text-sm font-medium text-emerald-400">
                    ${university.avgSalary}
                  </div>
                </div>
              </div>
            </div>
        ...
        {university.website && (
          <div className="mt-12 flex justify-center">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-10 py-4 rounded-2xl font-semibold text-base text-white no-underline bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 transition-all duration-300 border border-purple-500/40 shadow-lg shadow-indigo-600/20 hover:shadow-indigo-600/40 hover:scale-[1.02] active:scale-[0.98]"
            >
