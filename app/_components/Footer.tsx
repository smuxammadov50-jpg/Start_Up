...
export default function Footer() {
  return (
    <div className="relative border-t border-white/30 bg-black/50">

      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] y from-transparent via-indigo-500/35 " />
